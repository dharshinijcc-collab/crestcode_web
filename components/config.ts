...
export const siteConfig = {
  ...
  careers: {
    PAGE_DATA: {
      hero: {
        badge: "WE'RE HIRING GLOBALLY",
        titleMain: "Build Meaningful ",
        titleAccent: "Technology",
        titleEnd: " With Us",
        description: "Join a team that values ownership, learning, and building scalable digital products used by startups and growing businesses.",
  ...
  main_hackathon: {
    CONTENT: {
      ...
      upcomingEvent: {
        ...
        description: "Join the biggest gathering of student developers and entrepreneurs this semester to pitch ideas to industry leaders and VCs."
      },
      features: [
        {
          icon: "Code2",
