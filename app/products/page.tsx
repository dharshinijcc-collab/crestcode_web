    ...
    <div style={{ backgroundColor: COLORS.bgBase, fontFamily: FONT_PRIMARY, minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '0 24px 100px' }}>
        ...
        <div style={{ 
          ...
          gap: '48px', // Increased gap for the "middle gap" effect
          rowGap: '48px' 
        }}>
          ...
          >
            ...
            <h2 style={{ fontSize: '20px', fontWeight: 800, marginBottom: '12px', color: COLORS.textBlack }}>MVP Estimator</h2>
            <p style={{ color: COLORS.textMuted, lineHeight: 1.6, marginBottom: '24px', fontSize: '15px' }}>
          ...
          >
            ...
            <h2 style={{ fontSize: '20px', fontWeight: 800, marginBottom: '12px', color: COLORS.textBlack }}>Validate Your Idea</h2>
            <p style={{ color: COLORS.textMuted, lineHeight: 1.6, marginBottom: '24px', fontSize: '15px' }}>
          ...
          >
            ...
            <h2 style={{ fontSize: '20px', fontWeight: 800, marginBottom: '12px', color: COLORS.textBlack }}>HIPAA Compliance</h2>
            <p style={{ color: COLORS.textMuted, lineHeight: 1.6, marginBottom: '24px', fontSize: '15px' }}>
          ...
          >
            ...
            <h2 style={{ fontSize: '20px', fontWeight: 800, marginBottom: '12px', color: COLORS.textBlack }}>Data Encryption</h2>
            <p style={{ color: COLORS.textMuted, lineHeight: 1.6, marginBottom: '24px', fontSize: '15px' }}>
